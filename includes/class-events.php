...
class Events {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-events-admin-metaboxes.php';
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-events-template-functions.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/events-global-methods.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-events-shared.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-events-sanitizer.php';
	...
	{
		$plugin_metaboxes = new Events_Admin_Metaboxes( $this->get_plugin_name(), $this->get_version() );

		$this->loader->add_action( 'add_meta_boxes', $plugin_metaboxes, 'add_metaboxes' );
		$this->loader->add_action( 'add_meta_boxes_el_events', $plugin_metaboxes, 'set_meta' );
		$this->loader->add_action( 'save_post_el_events', $plugin_metaboxes, 'validate_meta', 10, 2 );
	}
